...
#PBS -e /home/cfrench/enyalius_hinge_second_errors.e
#PBS -o /home/cfrench/enyalius_hinge_second_output.o
...
mpirun --mca btl ^tcp -machinefile $PBS_NODEFILE -np ${NPROCS} python3 demographic_simulations_hinge_second.py
