...
#PBS -e /home/cfrench/cat_second_hinge_errors.e
#PBS -o /home/cfrench/cat_second_hinge_output.o
...
mpirun --mca btl ^tcp -machinefile $PBS_NODEFILE -np ${NPROCS} python3 demographic_simulations_cat_hinge_second.py
