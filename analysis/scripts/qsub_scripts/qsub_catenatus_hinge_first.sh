...
#PBS -e /home/cfrench/cat_first_hinge_errors.e
#PBS -o /home/cfrench/cat_first_hinge_output.o
...
mpirun --mca btl ^tcp -machinefile $PBS_NODEFILE -np ${NPROCS} python3 demographic_simulations_cat_hinge_first.py
