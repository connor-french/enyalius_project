...
### Set the job name
#PBS -N enyalius-sims-ConnorFrench
...
#PBS -e /home/cfrench/enyalius_errors.e
#PBS -o /home/cfrench/enyalius_output.o
...
${MPIRUN}  --mca btl ^tcp -machinefile $PBS_NODEFILE -np ${NPROCS} demography_simulations.py
