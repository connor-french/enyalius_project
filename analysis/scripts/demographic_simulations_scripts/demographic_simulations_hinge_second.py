    ...
    for sim in range(n_sims):
        ...
        try:
            ...
            for m in range(len(mut_rates)):
                ...
                # test to see if there's something weird
                print(params_df)
                print(sumstats)    
...
def main():
    ...
    admix_rast_path = "admix_id_rast.tif"
    ...
    out_prefix_linear = "sims_2024-01-25_linear_first2"
    out_prefix_hinge = "sims_2023-02-15_hinge_second"
    ...
    hinge_sim_params = list(itertools.product(*[max_k, Nm, ancestral_size_list, ancestral_merge_time_list, recomb_rate, thresh, sp_merge_time_list]))
    ...
    # restart from where it dropped off
    hinge_sim_params_second = hinge_sim_params_second[4705:]
    ### hinge sims
