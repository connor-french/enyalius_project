...
def main():
    ...
    out_prefix_linear = "sims_2024-02-20_cat_linear"
    ...
    ## I HARDCODED THESE FOR EXPLORATORY PURPOSES, BUT NEED TO CHANGE THEM TO n_p FOR THE FINAL SIMS
    ancestral_size_a1 = np.linspace(5e5, 3e6, n_p, dtype=int)
