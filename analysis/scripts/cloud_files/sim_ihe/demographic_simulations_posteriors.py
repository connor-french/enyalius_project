...
if __name__=="__main__":
    ...
    admix_rast_path = "admix_id_rast_ihe.tif"
    ...
    out_prefix = "sims_2024-03-25_posterior"
    ...
    hinge_sim_params = random.sample(hinge_sim_params, 100)
