...
```
    ...
    /Users/connorfrench/miniforge3/envs/enyalius/bin/python
...
```
    ...
    Landscape with K assignment categories written to output/admix_rasters/admix_id_rast_ihe.tif.
...
|     | num_var | sfs_h1_a1 | sfs_h2_a1 | sfs_h3_a1 | pi_a1    | pi_sd_a1 | taj_d_a1  | taj_d_sd_a1 | sfs_h1_a2 | sfs_h2_a2 | ... | dxy_6527_8725 | fst_6527_8725 | dxy_6527_10257 | fst_6527_10257 | dxy_8725_10257 | fst_8725_10257 | ibd_dxy_slope_a2 | ibd_dxy_r2_a2 | ibd_fst_slope_a2 | ibd_fst_r2_a2 |
|-----|---------|-----------|-----------|-----------|----------|----------|-----------|-------------|-----------|-----------|-----|---------------|---------------|----------------|----------------|----------------|----------------|------------------|---------------|------------------|---------------|
| 0   | 12722   | 0.429219  | 0.288204  | 0.244078  | 0.158715 | 0.137272 | -0.351671 | 0.221594    | 0.293657  | 0.171489  | ... | 0.083996      | 0.406337      | 0.085676       | 0.516192       | 0.067725       | 0.230726       | 0.013866         | 0.06476       | 0.407159         | 0.292327      |
...
```
    ...
    Landscape with K assignment categories written to output/admix_rasters/admix_id_rast_cat.tif.
...
<img
src="empirical_sumstats_files/figure-commonmark/admix-id-map-output-1.png"
id="admix-id-map" />
...
|     | num_var | sfs_h1_a2 | sfs_h2_a2 | sfs_h3_a2 | pi_a2    | pi_sd_a2 | taj_d_a2  | taj_d_sd_a2 | sfs_h1_a1 | sfs_h2_a1 | ... | dxy_4316_4383 | fst_4316_4383 | dxy_4316_4384 | fst_4316_4384 | dxy_4383_4384 | fst_4383_4384 | ibd_dxy_slope_a3 | ibd_dxy_r2_a3 | ibd_fst_slope_a3 | ibd_fst_r2_a3 |
|-----|---------|-----------|-----------|-----------|----------|----------|-----------|-------------|-----------|-----------|-----|---------------|---------------|---------------|---------------|---------------|---------------|------------------|---------------|------------------|---------------|
| 0   | 14916   | 0.347355  | 0.209338  | 0.174333  | 0.107814 | 0.156359 | -0.000312 | 0.277006    | 0.42111   | 0.253423  | ... | 0.118827      | 0.190487      | 0.119334      | 0.194688      | 0.113152      | 0.164962      | 0.014308         | 0.45604       | 0.136318         | 0.844334      |
